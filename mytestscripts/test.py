...
if __name__ == "__main__":
    string="User: What do you call a cow with 3 legs? Humorous reply: Lean beef.What do you call a cow with no legs?Ground beef.What do you call a cow with two legs?Yo momma. <|endoftext|> "

    GPT2TokenizerFast.max_model_input_sizes['gpt2'] = 1e20  # disables a misleading warning
    encoder = GPT2TokenizerFast.from_pretrained('gpt2')

    reader = Reader('./dataset/train/train.txt')
    string_iterable = reader.stream_data(threaded=False)
